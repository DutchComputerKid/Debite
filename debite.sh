...
echo -en "\033[1;34mVersion: 0.3\033[0m\n"
    ...
    for instll in "$var"; do
        ...
        7)
            ...
            if [ -f "/usr/bin/code" ]; then
                ...
                if [ -f "/etc/apt/sources.list.d/vscode.list" ]; then
                    ...
                    echo "# deb-src [arch=amd64] https://packages.microsoft.com/repos/vscode stable main" >>/etc/apt/sources.list.d/vscode.list
                fi
        ...
        10)
            if [ -f "/usr/bin/discord" ]; then
                ...
                dpkg --force-confold --force-confdef -i discordapp.deb &>/dev/null
        ...
        11)
            ...
            wget -q -O $scriptdl/subsonic.deb "https://s3-eu-west-1.amazonaws.com/subsonic-public/download/subsonic-6.1.5.deb" 2</dev/null
